...
<body>
    <div class="container" id='containerPrincipal'>
        <h1 class='text-center shadow p-3 mb-5 bg-white rounded'>Marcas</h1>
        ...
        <a href="" class="btn btn-lg btn-dark" data-toggle="modal" data-target="#cadastrarForm">Cadastrar nova marca</a>
        ...
        <div class="modal fade" id="alterarForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            <button class="btn btn-deep-orange" id='AlterarModalBtn'>Alterar Dados</button>
                        </div>
