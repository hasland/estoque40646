...
<body>
    <div class="container" id='containerPrincipal'>
        ...
        <h1 class='text-center shadow p-3 mb-5 bg-white rounded'>Carros</h1>
        <!--tabela de garagens-->
        ...
        <a href="" class="btn btn-lg btn-dark" data-toggle="modal" data-target="#cadastrarForm">Cadastrar novo carro</a>
